...
describe('Testing Operator functionality (L1)', async function () {
  ...
  describe('Test Operator bonding', async function () {
    it('should fail bonding less than minimum', async function () {
      ...
      await expect(l1.operator.bondUtilityToken(l1.deployer.address, BigNumber.from('100000000000000000'), 0)).to.be.revertedWith('HOLOGRAPH: bond amount too small');
      await expect(l1.operator.bondUtilityToken(l1.deployer.address, BigNumber.from('1000000000000000000'), 1)).to.be.revertedWith('HOLOGRAPH: bond amount too small');
    });
    it('should bond to pod index 0', async function () {
      await expect(l1.operator.bondUtilityToken(l1.deployer.address, BigNumber.from('1000000000000000000'), 0)).to.not.be.reverted;
    ...
    it('should bond 10 wallets to pods', async function () {
      ...
      await expect(l1.operator.bondUtilityToken(l1.wallet3.address, BigNumber.from('1000000000000000000'), 0)).to.not.be.reverted;
      await expect(l1.operator.bondUtilityToken(l1.wallet4.address, BigNumber.from('1000000000000000000'), 0)).to.not.be.reverted;
      await expect(l1.operator.bondUtilityToken(l1.wallet5.address, BigNumber.from('1000000000000000000'), 0)).to.not.be.reverted;
      await expect(l1.operator.bondUtilityToken(l1.wallet6.address, BigNumber.from('1000000000000000000'), 0)).to.not.be.reverted;
      await expect(l1.operator.bondUtilityToken(l1.wallet7.address, BigNumber.from('1000000000000000000'), 0)).to.not.be.reverted;
      await expect(l1.operator.bondUtilityToken(l1.wallet8.address, BigNumber.from('1000000000000000000'), 0)).to.not.be.reverted;
      await expect(l1.operator.bondUtilityToken(l1.wallet9.address, BigNumber.from('1000000000000000000'), 0)).to.not.be.reverted;
      await expect(l1.operator.bondUtilityToken(l1.wallet10.address, BigNumber.from('1000000000000000000'), 0)).to.not.be.reverted;
...
*/
    ...
    it('should fail double-bonding', async function () {
      await expect(l1.operator.bondUtilityToken(l1.deployer.address, BigNumber.from('4000000000000000000'), 1)).to.be.revertedWith('HOLOGRAPH: operator is bonded');
    });
  });
