...
export const ROYALTIES_ALREADY_INITIALIZED_ERROR_MSG = 'ROYALTIES: already initialized';
...
export const ROYALTIES_ONLY_OWNER_ERROR_MSG = 'ROYALTIES: caller not an owner';
