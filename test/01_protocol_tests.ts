...
//    sampleErc721 = (await ethers.getContract('SampleERC721')) as SampleERC721;
  ...
  describe('Check contract addresses', async () => {
    it('should not be empty', async () => {
      ...
      expect(holographBridgeProxy.address != '', 'holographBridgeProxy.address = ' + holographBridgeProxy.address).to.be.true;
      ...
      expect(holographFactoryProxy.address != '', 'holographFactoryProxy.address = ' + holographFactoryProxy.address).to.be.true;
      ...
      expect(holographRegistryProxy.address != '', 'holographRegistryProxy.address = ' + holographRegistryProxy.address).to.be.true;
