...
contract HolographDeployerTest is Test {
    ...
    function test_deploy_emitsEvent() public {
        ...
        emit ContractDeployed(deployer.computeAddress(testContractBytecode, salt), alice, salt, creationCodeHash);
    ...
    function test_deployAndCall_emitsEvent() public {
        ...
        emit ContractDeployedAndInitialized(
            deployer.computeAddress(testContractBytecode, salt), alice, salt, keccak256(testContractBytecode), initData
        );
    ...
    function test_safeCreate2_revertPreDeploymentMismatch() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                HolographDeployer.PreDeploymentAddressMismatch.selector, wrongExpectedAddress, computedAddress
            )
        );
        vm.prank(alice);
    ...
    function test_safeCreate2AndCall_success() public {
        ...
        vm.prank(alice);
        address deployed = deployer.safeCreate2AndCall(testContractBytecode, salt, expectedAddress, initData);
    ...
    function test_verifyDeploymentAddress_revert() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(HolographDeployer.PostDeploymentAddressMismatch.selector, expected, actual)
        );
        deployer.verifyDeploymentAddress(expected, actual);
    }
